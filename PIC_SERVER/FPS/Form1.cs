...
namespace FPS
{
    public partial class Form1 : Form
    {
       ...
       public static int s = 1; 
        ...
        private void btPrint_Click(object sender, EventArgs e)
        {
            if(Display.iButtonSelected > 0)
            {
                ...
                {
                    String trnasc_id =lbl_arr[Display.iButtonSelected-4].Text ;

                    

                    DB.PrintReceipt(trnasc_id);
                }
        ...
        {
            lbl_arr = new Label[] { btn4_id,btn5_id, btn6_id, btn7_id, btn8_id, btn9_id, btn10_id };
            Config_AutoEOD();
       ...
       public static string sConfig, EODStatus="",HOURS="",MINUTES="",INTERVAL="";
        ...
        public void view_all_trans_Click(object sender, EventArgs e)
        {
